    ...
    new Vue({
        ...
        methods: {
            ...
            subscribeToChannel(channel) {
                this.pusher.subscribe('{{ \Gajosu\LaravelWebSockets\Dashboard\DashboardLogger::LOG_CHANNEL_PREFIX }}' + channel)
            ...
            subscribeToStatistics() {
                this.pusher.subscribe('{{ \Gajosu\LaravelWebSockets\Dashboard\DashboardLogger::LOG_CHANNEL_PREFIX }}statistics')
